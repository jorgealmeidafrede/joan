...
$conn       = new mysqli( '172.10.0.9', 'root', 'root', 'vilamasana' );
...
$query = "Select * FROM contenido_hi WHERE anos >= 1845 AND anos <= 1850";
    ...
    <div class="col-md-10 col-md-offset-1">
        ...
        <table class="table table-striped table-condensed table-bordered table-rounded">
            ...
            <?php for( $i = 0; $i < count( $results->data ); $i++ ) : ?>
                <tr>
                    <td><?php echo $results->data[$i]['contenido']; ?></td>
                    <td><?php echo $results->data[$i]['anos']; ?></td>
